...
describe('MenuGroupService.getStaffMenu() - Service Unit Tests', () => {
  ...
  beforeAll(async () => {
    ...
    category = await Category.create({
      merchant: merchant._id,
      name: { en: 'Staff Menu', am: 'á‹¨áˆ°áˆ«á‰°áŠžá‰½ áˆáŠ“áˆŒ' },
      isActive: true,
    });
    ...
    menuItem1 = await MenuItem.create({
      ...
      name: { en: 'Staff Burger', am: 'á‹¨áˆ°áˆ«á‰°áŠžá‰½ á‰ áˆ­áŒˆáˆ­' },
      description: { en: 'Burger for staff', am: 'áˆˆáˆ°áˆ«á‰°áŠžá‰½ á‰ áˆ­áŒˆáˆ­' },
      type: 'food',
    ...
    menuItem2 = await MenuItem.create({
      merchant: merchant._id,
      categoryId: category._id,
      name: { en: 'Staff Pizza', am: 'á‹¨áˆ°áˆ«á‰°áŠžá‰½ á’á‹›' },
      description: { en: 'Pizza for staff', am: 'áˆˆáˆ°áˆ«á‰°áŠžá‰½ á’á‹›' },
      type: 'food',
    ...
    const menuItem3 = await MenuItem.create({
      merchant: merchant._id,
      categoryId: category._id,
      name: { en: 'Scheduled Special', am: 'á‰ áŒŠá‹œ áˆá‹©' },
      description: { en: 'Only on weekdays', am: 'á‰ áˆ³áˆáŠ•á‰µ á‰€áŠ“á‰µ á‰¥á‰»' },
      type: 'food',
    ...
    deletedItem = await MenuItem.create({
      merchant: merchant._id,
      categoryId: category._id,
      name: { en: 'Deleted Staff Item', am: 'á‹¨á‰°áˆ°áˆ¨á‹˜' },
      type: 'food',
    ...
    alwaysVisibleGroup = await MenuGroup.create({
      merchant: merchant._id,
      branches: [branch._id],
      name: { en: 'Staff Always Available', am: 'áˆáˆáŒŠá‹œ á‹­áŒˆáŠ›áˆ' },
      visibility: 'always',
      priority: 10,
      items: [
    ...
    scheduledGroup = await MenuGroup.create({
      merchant: merchant._id,
      branches: [branch._id],
      name: { en: 'Staff Scheduled', am: 'á‰ áŒŠá‹œ á‹­áŒˆáŠ›áˆ' },
    ...
    hiddenGroup = await MenuGroup.create({
      merchant: merchant._id,
      branches: [branch._id],
      name: { en: 'Staff Hidden', am: 'á‹¨á‰°á‹°á‰ á‰€' },
      visibility: 'hidden',
      priority: 1,
  ...
  describe('Basic Functionality', () => {
    ...
    test('should enforce multi-tenant isolation', async () => {
      ...
      const category2 = await Category.create({
        merchant: merchant2._id,
        name: { en: 'Competitor Staff Dishes', am: 'á‹¨á‰°áŽáŠ«áŠ«áˆª á‹¨áˆ°áˆ«á‰°áŠžá‰½ áˆáŒá‰¦á‰½' },
        isActive: true,
      });
      ...
      const competitorItem = await MenuItem.create({
        ...
        name: { en: 'Competitor Staff Pizza', am: 'á‹¨á‰°áŽáŠ«áŠ«áˆª á‹¨áˆ°áˆ«á‰°áŠžá‰½ á’á‹›' },
        type: 'food',
      ...
      const competitorGroup = await MenuGroup.create({
        ...
        name: { en: 'Competitor Staff Menu', am: 'á‹¨á‰°áŽáŠ«áŠ«áˆª á‹¨áˆ°áˆ«á‰°áŠžá‰½ áˆáŠ“áˆŒ' },
        visibility: 'always',
        priority: 100,
  ...
  describe('Soft Delete Handling', () => {
    ...
    test('should NOT include unavailable items', async () => {
      const unavailableItem = await MenuItem.create({
        merchant: merchant._id,
        categoryId: category._id,
        name: { en: 'Unavailable Staff Item', am: 'á‹¨áˆ›á‹­áŒˆáŠ' },
        type: 'food',
  ...
  describe('Item Deduplication', () => {
    ...
    test('should use highest priority group data when item appears in multiple groups', async () => {
      ...
      const sharedStaffItem = await MenuItem.create({
        merchant: merchant._id,
        categoryId: category._id,
        name: { en: 'Shared Staff Item', am: 'á‹¨á‰°áŒ‹áˆ« á‹¨áˆ°áˆ«á‰°áŠžá‰½' },
        description: { en: 'Base staff description', am: 'áˆ˜áˆ°áˆ¨á‰³á‹Š áˆ˜áŒáˆˆáŒ«' },
        type: 'food',
      ...
      const highPriorityStaffGroup = await MenuGroup.create({
        merchant: merchant._id,
        branches: [branch._id],
        name: { en: 'Premium Staff Selection', am: 'áˆá‹© á‹¨áˆ°áˆ«á‰°áŠžá‰½ áˆáˆ­áŒ«' },
        visibility: 'always',
      ...
      const lowPriorityStaffGroup = await MenuGroup.create({
        merchant: merchant._id,
        branches: [branch._id],
        name: { en: 'Budget Staff Selection', am: 'áŠ¢áŠ®áŠ–áˆšá‹«á‹Š á‹¨áˆ°áˆ«á‰°áŠžá‰½ áˆáˆ­áŒ«' },
        visibility: 'always',
    ...
    test('should use deterministic tie-breaking when groups have same priority', async () => {
      ...
      const tieStaffItem = await MenuItem.create({
        merchant: merchant._id,
        categoryId: category._id,
        name: { en: 'Staff Tie Item', am: 'á‹¨áˆ°áˆ«á‰°áŠžá‰½ áŠ¥áŠ©áˆ' },
        description: { en: 'Staff item with tie', am: 'áŠ¥áŠ©áˆ' },
        type: 'food',
        variants: [{ name: 'Regular', price: 110, isDefault: true }],
        available: true,
        inStock: true,
      ...
      const staffGroup1 = await MenuGroup.create({
        merchant: merchant._id,
        branches: [branch._id],
        name: { en: 'Staff First Group', am: 'á‹¨áˆ°áˆ«á‰°áŠžá‰½ á‹¨áˆ˜áŒ€áˆ˜áˆªá‹«' },
        visibility: 'always',
        priority: 10,
        items: [{
      ...
      const staffGroup2 = await MenuGroup.create({
        merchant: merchant._id,
        branches: [branch._id],
        name: { en: 'Staff Second Group', am: 'á‹¨áˆ°áˆ«á‰°áŠžá‰½ áˆáˆˆá‰°áŠ›' },
        visibility: 'always',
